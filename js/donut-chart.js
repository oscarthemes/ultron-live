...
AmCharts.themes.light = {
    ...
    AmCoordinateChart: {
        colors: ["#ec3737", "#a32dd9", "#df661d", "#cc4748", "#cd82ad", "#2f4074", "#448e4d", "#b7b83f", "#b9783f", "#b93e3d", "#913167"]
    },
    AmStockChart: {
        colors: ["#ec3737", "#a32dd9", "#df661d", "#cc4748", "#cd82ad", "#2f4074", "#448e4d", "#b7b83f", "#b9783f", "#b93e3d", "#913167"]
    },
    ...
    if (void 0 !== e.responsive && e.responsive.ready !== !0 && e.responsive.enabled === !0) {
        ...
        if (!(i.length < 2 || Number(i[0]) < 3 || 3 === Number(i[0]) && Number(i[1]) < 13)) {
            ...
            var a = {
                ...
                h = function(e, i, a) {
                    var r = s + i;
                    r in e || (e[r] = i in e ? e[i] : g), e[i] = l(a), t.overridden.push({
                        object: e,
                        property: i
                    })
                },
